...
public class BasketShow {
	...
	public void showBasket(Connection conn) throws Exception {
		System.out.println("===== 장바구니 =====");
		String sql = "SELECT BASKET_NO, PROD_NO, BASKET_DATE, BUY_YN, LETTER, LETTER_POTION FROM BASKET B JOIN PRODUCT P ON B.PROD_NO = P.PROD_NO ORDER BY PROD_NO";
